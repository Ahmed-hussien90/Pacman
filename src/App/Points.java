...
public class Points {
    ...
    static  {
        ...
        PointsList = Arrays.stream(initPoints).map(p -> new Points((int) p[0], p[1], p[2], (int) p[3], (int) p[4], (int) p[5], (int) p[6], false)).toList();
        ...
        FruitsList = Arrays.stream(initFruits).map(p -> new Points((int) p[0], p[1], p[2], -1, -1, -1, -1, false)).toList();
    }
