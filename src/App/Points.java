...
public class Points {
    ...
    public static Map<Integer, Points> PointsList = Map.<Integer, Points>ofEntries(
            ...
            Map.entry(5 , new Points(Point,51    , 58    , 6     , -1    , 81    , 4     , false)),
            Map.entry(6 , new Points(Point,51    , 68    , -1    , 5     , -1    , 7     , false)),
            Map.entry(7 , new Points(Point,61.25 , 68    , 8     , -1    , 6     , -1    , false)),
            Map.entry(8 , new Points(Point,61.25 , 77.5  , -1    , 7     , 9     , 16    , false)),
            Map.entry(9 , new Points(Point,51    , 77.5  , 10    , -1    , 57    , 8     , false)),
            Map.entry(10, new Points(Point,51    , 90.5  , -1    , 9     , -1    , 11    , false)),
            ...
            Map.entry(26, new Points(Point,51    , 0     , 27    , -1    , 38    , 69    , false)),
            Map.entry(27, new Points(Point,51    , 10    , -1    , 26    , -1    , 28    , false)),
            ...
            Map.entry(32, new Points(Point,51    , 29    , -1    , 33    , -1    , 67    , false)),
            Map.entry(33, new Points(Point,51    , 19    , 32    , -1    , 34    , 29    , false)),
            Map.entry(34, new Points(Point,40    , 19    , 49    , -1    , 35    , 33    , false)),
            Map.entry(35, new Points(Point,29    , 19    , -1    , 36    , 46    , 34    , false)),
            Map.entry(36, new Points(Point,29    , 10    , 35    , -1    , -1    , 37    , false)),
            Map.entry(37, new Points(Point,40    , 10    , -1    , 38    , 36    , -1    , false)),
            Map.entry(38, new Points(Point,40    , 0     , 37    , -1    , 68    , 26    , false)),
            ...
            Map.entry(49, new Points(Point,40    , 29    , -1    , 34    , 48    , -1    , false)),
            ...
            Map.entry(53, new Points(Point,40    , 58    , 54    , -1    , 52    , 81    , false)),
            Map.entry(54, new Points(Point,40    , 68    , -1    , 53    , 55    , -1    , false)),
            Map.entry(55, new Points(Point,29    , 68    , 56    , -1    , -1    , 54    , false)),
            Map.entry(56, new Points(Point,29    , 77.5  , -1    , 55    , 64    , 57    , false)),
            Map.entry(57, new Points(Point,40    , 77.5  , 58    , -1    , 56    , 9     , false)),
            Map.entry(58, new Points(Point,40    , 90.5  , -1    , 57    , 72    , -1    , false)),
            ...
            Map.entry(68, new Points(Fruit,20    , 0     , -1    , -1    , 39    , 38    , false)),
            Map.entry(69, new Points(Fruit,69    , 0     , -1    , -1    , 26    , 25    , false)),
            Map.entry(70, new Points(Fruit,18    , 59    , 63    , 65    , -1    , -1    , false)),
            Map.entry(71, new Points(Fruit,71.5  , 59    , 15    , 17    , -1    , -1    , false)),
            ...
            Map.entry(82, new Points(Point,52    , 48    , -1    , -1    , 80    , -1    , false)),
            Map.entry(83, new Points(Point,38    , 48    , -1    , -1    , -1    , 80    , false))
    );
