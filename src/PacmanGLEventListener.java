...
public class PacmanGLEventListener implements GLEventListener , KeyListener {
    ...
    private void addPoints() {
        ...
        pointsList.add(new points(29,61.5 , 19   , 19, 31, 29, -1));
        pointsList.add(new points(30,72   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(31,72   , 10   , -1, -1, -1, -1));
        pointsList.add(new points(32,51   , 29   , -1, -1, -1, -1));
        pointsList.add(new points(33,51   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(34,40   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(35,29   , 10   , -1, -1, -1, -1));
        pointsList.add(new points(36,29   , 29   , -1, -1, -1, -1));
        pointsList.add(new points(37,40   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(38,40   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(39,0    , 19   , -1, -1, -1, -1));
        pointsList.add(new points(40,0    , 10   , -1, -1, -1, -1));
        pointsList.add(new points(41,8    , 10   , -1, -1, -1, -1));
        pointsList.add(new points(42,8    , 0    , -1, -1, -1, -1));
        pointsList.add(new points(43,0    , 0    , -1, -1, -1, -1));
        pointsList.add(new points(44,0    , 10   , -1, -1, -1, -1));
        pointsList.add(new points(45,18   , 10   , -1, -1, -1, -1));
        pointsList.add(new points(46,18   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(47,18   , 19   , -1, -1, -1, -1));
        pointsList.add(new points(48,29   , 29   , -1, -1, -1, -1));
